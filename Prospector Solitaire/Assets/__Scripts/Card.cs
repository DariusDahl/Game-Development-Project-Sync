...
public class Card : MonoBehaviour {
    ...
    public string colS = "Black";      // "Black" or "Red". Name of the Color
    ...
    // These private variables will be reused several times
    ...
    /// <summary>
    /// Adds a back to the card so that it renders on top of everything else
    /// </summary>
